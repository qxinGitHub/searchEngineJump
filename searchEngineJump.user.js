        ...
        // runAt.DOMContentLoaded(function () {
            ...
            SEJsetting.prototype = {
                ...
                init: function () {
                    ...
                    // 标题
                    var odivstitle = document.querySelectorAll(".sejtitle");
                    [].forEach.call(odivstitle,function(odiv){
                        odiv.addEventListener("click",that.titleClick,false);
                    });
                },
                addContent: function(){
                    ...
                    for (let i=0;i<detailsLength;i++){
                        ...
                        oDivTitle.innerHTML = details[j][0];
                        ...
                        for(let ii=0;ii<itemLength;ii++){
                            // console.log(ii);
                            // var jj = engineListItme[ii] ? ii : -ii;
                            var jj = ii;
                ...
                addEditBox: function(e){
                    ...
                    // console.log(target);
                    // data-iqxinimg    data-iqxintitle   data-iqxinlink   data-iqxintarget
                    ...
                    // this.editTemp = {"title":otitle,"link":olink,"icon":oicon,"otarget":otarget};
                    this.editTemp = target;

                    // console.log(otarget); //会出现两个值，undefined 或 _blank
                    var strblank;
                    if(otarget){
                ...
                addEditBoxEnger: function(){
                    // console.log("this.editTemp: ",this.editTemp);
                    ...
                    // console.log(oblank,odisabled);
                    // this.editTemp.title = otitle;
                    this.editTemp.dataset.iqxintitle = otitle;
                    // console.log(this.editTemp.lastChild);
                ...
                domdrop:function (e) {
                    ...
                    if (dragEl != this) {
                        ...
                        // var thatData = this.dataset.xin;
                        // this.dataset.xin = dragData;
                        // dragEl.dataset.xin = thatData
                    }    
                ...
                saveData: function(){
                    ...
                    for(let i=0;i<odetailsLength;i++){
                        // i = i>8?-i:i;
                        // details[i] = [odetails[i].innerHTML,odetails[i].dataset.iqxintitle];
